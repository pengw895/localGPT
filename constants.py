...
from langchain.document_loaders import JSONLoader, CSVLoader, PDFMinerLoader, TextLoader, UnstructuredExcelLoader, Docx2txtLoader
...
MODEL_ID = "openbmb/MiniCPM3-4B-GGUF"
MODEL_BASENAME = "minicpm3-4b-q4_k_m.gguf"
